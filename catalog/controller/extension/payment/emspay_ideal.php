...
class ControllerExtensionPaymentEmspayIdeal extends Controller
{
    ...
    public function __construct($registry)
    {
        ...
        //Раскоментировать при наличии правильного ApiKea и ENDPOINT
    ...
    protected function createOrder(array $orderData)
    {
        ...
        /*return $this->ems->createOrder([
            ...
            'issuer_id' => $orderData['issuer_id'],                 // Issuer ID (BIC/SWIFT)
            ...
            'plugin_version' => $orderData['plugin_version'],       // Extra information
